      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <h1 class="main-title">
            ...
            <span class="gradient-text">Instantly Predict the Future</span>
          </h1>
          
          <div class="hero-desc">
            <p>
              Even with just a paragraph of text, <span class="highlight-bold">MiroFish</span> can automatically generate a corresponding parallel world with up to <span class="highlight-orange">Millions of Agents</span> in scale. By injecting variables from a “God's-eye view”, find <span class="highlight-code">“local optimal solutions”</span> in dynamic environments through complex group interactions
            </p>
            <p class="slogan-text">
              Let the future be rehearsed in Agent swarms, let decisions prevail after countless simulations<span class="blinking-cursor">_</span>
            </p>
          </div>
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            <div class="metric-card">
              ...
              <div class="metric-label">Average $5/run for standard simulations</div>
            </div>
            <div class="metric-card">
              <div class="metric-value">High Availability</div>
              <div class="metric-label">Up to millions of Agents in simulation</div>
            </div>
          </div>

          <!-- Project simulation steps introduction (new section) -->
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity relation extraction & persona generation & environment configuration Agent injecting simulation parameters</div>
                </div>
              </div>
              <div class="workflow-item">
...
// Start simulation - immediately redirect, API calls are made on the Process page
